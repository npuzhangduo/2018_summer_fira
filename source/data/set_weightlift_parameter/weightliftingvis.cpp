/**** final version to put the darwin without params***/
/**********     attention   *************/
...
void Weightlift::imageProcess(cv::Mat image)
{
    set_NotFound();
    Load_std_img();
    Pretreat(image);
...
//    ifstream ifile("3.txt");
	ifstream ifile("/home/robotis/Desktop/2017.9/source/data/set_weightlift_parameter/3.txt");
    if(!ifile){
        cerr<<"error"<<endl;
    }
    string lineword;
