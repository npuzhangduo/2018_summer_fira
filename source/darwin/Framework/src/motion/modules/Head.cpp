...
{
	m_Pan_p_gain = 0.1;
//m_Pan_p_gain = 0.08;//robocup
	m_Pan_d_gain = 0.22;
//m_Pan_d_gain = 0.25;

	m_Tilt_p_gain = 0.1;
//m_Tilt_p_gain = 0.08;//robocup
	m_Tilt_d_gain = 0.22;
//m_Tilt_d_gain = 0.25;
...
void Head::ChangePanLimit(double LeftLimit, double RightLimit)
{
...
void Head::MoveByAngleWithoutLimit(double pan, double tilt)
{
	m_Pan_err_diff = pan - m_PanAngle;
	m_Tilt_err_diff = tilt - m_TiltAngle;
	m_Pan_err = pan ;
