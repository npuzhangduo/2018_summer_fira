...
class LadderrunResult : public ImgProcResult
{
public:
    cv::Point2f center;
...
public:
    ...
    {
        LadderrunResult *tmp = dynamic_cast<LadderrunResult*>(&res);
        center = tmp->center;
    ...
    void operator=(LadderrunResult &res)
    {
        center = res.center;
...
class Ladderrun: public ImgProc
{
private:
