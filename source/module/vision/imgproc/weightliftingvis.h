/*** HSV vis for weightlifting ***/
/***              9.27           */
#ifndef WEIGHTLIFTINGVIS_H
#define WEIGHTLIFTINGVIS_H
...
class WeightliftResult : public ImgProcResult
{
public:
    cv::Point2f center;
...
public:
    ...
    {
        WeightliftResult *tmp = dynamic_cast<WeightliftResult*>(&res);
        center = tmp->center;

        obj_up = tmp->obj_up;
        obj_down = tmp->obj_down;
        obj_angle = tmp->obj_angle;
        obj_valid = tmp->obj_valid;
    }

    void operator = (WeightliftResult &res)
    {
        center = res.center;
        obj_up = res.obj_up;
        obj_down = res.obj_down;
        obj_angle = res.obj_angle;
        obj_valid = res.obj_valid;
    }
};

class Weightlift: public ImgProc
{
private:
...
public:
    ...
    WeightliftResult MyResult;
};

#endif // WEIGHTLIFTINGVIS_H
