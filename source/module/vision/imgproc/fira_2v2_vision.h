...
class Fira2v2VisionResult : public ImgProcResult
{
public:
...
public:
  ...
  {
  Fira2v2VisionResult *tmp = dynamic_cast<Fira2v2VisionResult*>(&res);
  ...
  void operator=(Fira2v2VisionResult &res)
  {
...
class Fira2v2Vision : public ImgProc
 //class Fira2v2Vision
{
/******Public******/
//public member
...
public:
    ...
    cv::MatND getFira2v2Vision(const cv::Mat& image);//计算1D直方图
    cv::Mat getFira2v2Vision_Image(const cv::Mat& image);//计算1D直方图并返回其分布图像，将直方图可视化，变为柱状图
