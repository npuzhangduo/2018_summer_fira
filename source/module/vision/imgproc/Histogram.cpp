...
//    int row_1 = trackbar_hsv_channel[0].rows;
...
void Histogram::Process_Basket(cv::Mat image)
{
    ...
    Erode_img(basket_project_result, basket_project_result, 2);
    Dilate_img(basket_project_result, basket_project_result, 2);
...
//    ifstream ifile("/home/zenghao/HuroCup 2017/Prepare/Archery/test_img/2.txt");
    ifstream ifile("../source/data/set-shot-parameter/3.txt");
